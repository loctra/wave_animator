...
@Deprecated
public class NativeRoundWaveView extends View {
    ...
    public NativeRoundWaveView(Context context) {
        this(context, null);
    }

    public NativeRoundWaveView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.NativeRoundWaveView);
        pointCount = typedArray.getInt(R.styleable.NativeRoundWaveView_pointCount, 0);
        useAnimation = typedArray.getBoolean(R.styleable.NativeRoundWaveView_useAnimation, true);
